...
@Component({
  ...
  templateUrl: './mostrar-mis-gastos-director.component.html',
  styleUrls: ['./mostrar-mis-gastos-director.component.css']
})
export class MostrarMisGastosDirectorComponent {
